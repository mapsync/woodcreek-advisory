    ...
    <div>
      ...
      <div className="footer">
        <div className="d-inline-block float-right">
          <a className="btn btn-sm btn-link tooltip tooltip-left" data-tooltip="Settings" rel="noopener noreferrer" href="https://woodcreekwater.geosync.cloud/admin" target="_blank">
...
const BlogPost = ({ data }) => {
  ...
  re = new RegExp("https://woodcreekwater.geosync.cloud/map", "g");
  post.html = post.html.replace(re, "/map");
